...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9wDj1Pb3IA', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ip+rYer6u2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_7f96bfeac676fd480226d8751683977dca09dab58c9d1e2744c02c13373b6171');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O9buyTWMYV', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o7AMGkqbtH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4S3rRlAdYD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle/Resources/views'), '!MgiletNotification');
        $instance->addPath(($this->targetDirs[3].'\\src\\ComplaintsBundle/Resources/views'), 'Complaints');
        $instance->addPath(($this->targetDirs[3].'\\src\\ComplaintsBundle/Resources/views'), '!Complaints');
        $instance->addPath(($this->targetDirs[3].'\\src\\FeedbackBundle/Resources/views'), 'Feedback');
        $instance->addPath(($this->targetDirs[3].'\\src\\FeedbackBundle/Resources/views'), '!Feedback');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'KnpSnappyBundle' => [
                    'parent' => NULL,
                    'path' => 'C:/xampp/htdocs/SmartStart/vendor/knplabs/knp-snappy-bundle',
                    'namespace' => 'Knp\\Bundle\\SnappyBundle',
                ],
                'ComplaintsBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ComplaintsBundle'),
                    'namespace' => 'ComplaintsBundle',
                ],
                'FeedbackBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\FeedbackBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ComplaintsBundle' => 'ComplaintsBundle\\ComplaintsBundle',
                'FeedbackBundle' => 'FeedbackBundle\\FeedbackBundle',
            ...
            'mailer_user' => 'smartstart1941@gmail.com',
            'mailer_password' => 'azerty1941',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'smartstart1941@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'azerty1941',
