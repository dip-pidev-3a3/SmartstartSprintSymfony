...
class __TwigTemplate_eae3febedcbd70b14dfc2b944a6f3e74009c41d0f19e5e4e70d88a5b1bd3e86b extends Twig_Template
{
        ...
        if ((twig_join_filter(($context["l"] ?? $this->getContext($context, "l"))) > 1000)) {
            ...
            echo "
                    ...
                    <ul class=\"list-group\">
                        ...
                        <li class=\"list-group-item text-right\"><span class=\"pull-left\"><strong>Likes</strong></span>";
            // line 56
            echo twig_escape_filter($this->env, (twig_join_filter(($context["l"] ?? $this->getContext($context, "l"))) * 0.0333), "html", null, true);
            echo " Dt</li>
                        <li class=\"list-group-item text-right\"><span class=\"pull-left\"><strong>Comments</strong></span> ";
            // line 57
            echo twig_escape_filter($this->env, (twig_join_filter(($context["com"] ?? $this->getContext($context, "com"))) * 0.00333), "html", null, true);
            echo " Dt</li>
                    </ul>
                        <br>
...
{% endblock %}", "BlogBundle:BlogViews:BlogManagment.html.twig", "C:\\xampp\\htdocs\\SmartStart\\src\\BlogBundle/Resources/views/BlogViews/BlogManagment.html.twig");
    }
}
