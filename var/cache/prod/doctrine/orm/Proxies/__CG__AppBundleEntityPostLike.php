 ...
 */
class PostLike extends \AppBundle\Entity\PostLike implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PostLike' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\PostLike' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\PostLike' . "\0" . 'post'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PostLike $proxy) {
